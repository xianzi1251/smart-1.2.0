angular.module('app.controllers').controller('teacherInfoCtrl', function(
            ...
            return productService.getProductInfo(ctrl.entityName)
                .success(function(response) {
                    ...
                    productService.getSuitCourses(ctrl.entityName)
                        .success(function(response) {
                            if (response.list[0].length) {
                                ctrl.teacherCourseList = response.list[0];
                                _.forEach(ctrl.teacherCourseList, function(item) {
